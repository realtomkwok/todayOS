	...
	return (
		...
		>
			<div className="flex justify-left items-center w-full h-fit gap-4">
				<motion.div 
					className="flex justify-center items-center bg-md-error rounded-full text-md-on-error text-xs font-display font-medium tracking-normal z-10 text-nowrap"
					animate={{
				...
				>
					...
					<div
						className="flex justify-center items-start gap-2 z-50"
					>
						<motion.span
							...
							animate={{
								fontVariationSettings: !props.isActive ? `'opsz' 24, 'wdth' 75, 'wght' 800` : `'opsz' 32, 'wdth' 75, 'wght' 200`,
								transition: transition.enter,
							}}
							exit={{
								fontVariationSettings: `'opsz' 32, 'wdth' 75, 'wght' 200`,
